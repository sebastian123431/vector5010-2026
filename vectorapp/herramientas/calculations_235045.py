...
# Descripción: Herramienta para: repara este código javascript por favor: function calcularTotal(precio, tasa) { var total = precio == 0 ? 0 : precio * tasa; document.getElementById('resultado').innerText = total; return total;
# Fecha de creación: 2026-09-10T23:50:45.123322
